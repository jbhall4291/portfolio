  ...
  return (
    <section id="about" className="About">
      ...
      <p>
        ...
        and honing my communication and problem-solving skills. However, my
        passion for technology and programming soon resurfaced as I found myself
        delving into various tools and platforms like Unity Engine, Unreal and
        Blender. I then expanded my horizons by exploring HTML and CSS, and was
        thrilled to discover the seemingly endless possibilities of JavaScript,
        which quickly became a focal point of my learning and experimentation.
      </p>
      ...
      <img className="About__img--right" src={ivyPic} alt="my old black cab" />
      <p>
        ...
        covered so much ground, and I was able to build on my existing knowledge
        to develop a deep understanding of web development. By the end of the
        course, I was pitching, planning, and then building full-stack apps!
        When I'm not working on my latest programming project, you can find me
        enjoying a delicious slice of pizza or spending time with my beloved pug
        Ivy in the great outdoors.
        <br></br>
        <br></br>
